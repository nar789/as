...
<body>
	...
	<table id='gv'>
		...
		<tr>
			<td><form name="upload-form" action="upload2.php" method="post" enctype="multipart/form-data">
		...
		<tr>
			...
			<?
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					echo "<td>".$row['no']."</td>";
					echo "<td>";
					echo "<form name=\"upload-form\" action=\"upload2.php?no=".$row['no']."\" method=\"post\" enctype=\"multipart/form-data\"><input type=\"hidden\" name=\"MAX_FILE_SIZE\" value=\"25242880\"/>
						<input type=file name=upload id=upload>
						<input type=submit value='이미지업로드'>
						</form>";
