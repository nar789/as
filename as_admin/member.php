...
<body>
	...
	<table id='gv'>
		...
		<tr>
			...
			<td><input type=text class='inputtext short' id=title></td>
			<td><input type=text class='inputtext short' id=content></td>
		...
		<tr>
			...
			<?
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					echo "<td><input type=text class='inputtext short' id=".$cnt."title value=".$row['title']."></td>";
					echo "<td><input type=text class='inputtext short' id=".$cnt."content value=".$row['content']."></td>";
